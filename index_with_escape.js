document.addEventListener('DOMContentLoaded', function () {
    ...
    function fuzzySearch(query) {
        ...
        const url = decodeURL('aHR0cHM6Ly9yYXJiZy1kdW1wLnJ1bi5nb29ybS5pby8/cT0');
        fetch(url + escapeSpecialCharacters(query), {
            mode: 'cors',
            headers: {
                'Origin': 'https://rarbg.coomer.party' // Replace with the actual origin of your website
            }
        })
